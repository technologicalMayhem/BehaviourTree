...
namespace BehaviourTrees.Model
{
    ...
    public sealed class BlackboardKeyAttribute : Attribute
    {
        ...
        /// </summary>
        /// <param name="key">
        ///     The key of the variable in the blackboard. If this matches a field name then the value of that member
        ...
        /// <summary>
        ///     The key of the variable in the blackboard. If this matches a field name then the value of that member will be used
        ///     as a key instead.
        /// </summary>
